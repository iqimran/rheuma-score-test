      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <header className="mb-8 text-center"> 
          <div className="flex items-center justify-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-slate-800">DAS28-CRP Calculator</h1>
          </div>
          <p className="text-slate-600">Disease Activity Score-28 for Rheumatoid Arthritis with CRP</p>
        </header>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="bg-slate-50 rounded-lg p-4 font-mono text-sm mb-4 overflow-x-auto">
                <div className="text-slate-700 mb-3">
                  <strong>DAS28-CRP</strong> = 0.56×√(TJC) + 0.28×√(SJC) + 0.36×ln(CRP+1) + 0.014×GH×10 + 0.96
                </div>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-slate-50 rounded-xl border border-slate-200 p-6">
              <h3 className="font-semibold text-slate-800 mb-3">About DAS28-CRP</h3>
              <p className="text-sm text-slate-600 leading-relaxed">
                The Disease Activity Score-28 with CRP is a validated measure of rheumatoid arthritis disease activity.
